...
module.exports = function (app) {
  ...
  Download.prototype.cleanBeforeDl = function (){
    ...
    fs.unlink(temp_loc_mp3, function (err){
      if(err) logWarn('@clean: could not delete ' + temp_loc_mp3);
      else log('Succesfuly deleted: ' + temp_loc_mp3);

      fs.unlink(temp_loc_mp4, function (err){
        if(err) logWarn('@clean: could not delete ' + temp_loc_mp4);
        else log('Succesfuly deleted: ' + temp_loc_mp4);
