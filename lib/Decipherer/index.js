...
module.exports = function (app){
   ...
   * @public
   */
  Decipherer.prototype.inlineSwapper = function (){
    var decipher_function_body = this.d.decipher_function_body,
        decipher_function_body_1st_char = decipher_function_body.charAt(0);
    ...
    // Set solution variable to the correct solution name
    var solution = undefined;

    if(has_scoped_manip)
      solution = 'scoped_manip';
    else if(has_namespaced_var_manip)
      solution = 'namespaced_var_manip';
    else if(has_var_manip)
      solution = 'var_manip';
    else
      return this.f_retryAll('@inlineSwapper: no swapper solution'); 
