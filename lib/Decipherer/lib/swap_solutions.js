module.exports = function (/*app*/) {
  ...
  /**
   * Extracts a named object literal
   * @param {string} obj - Named object to extract from code
   * @param {string} code - Code to extract named object from
   */
  ...
  var solutions = {
    ...
    var_manip: function (decipher_body, html5player, decipherer) {
      ...
      for (i = 0, args = '('; i < swapper_args.length; i++) {
        args += swapper_args[i] + ',';
      }
      args = args.slice(0, -1) + ')';
